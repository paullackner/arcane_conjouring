...
public class MagicBoltRenderer extends EntityRenderer<MagicBolt> {
    private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("arcane_conjouring:textures/magic/magic_bolt.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public MagicBoltRenderer(EntityRendererProvider.Context p_174008_) {
        super(p_174008_);
    }

    @Override
    protected int getBlockLightLevel(MagicBolt p_114496_, BlockPos p_114497_) {
        return 15;
    }

    @Override
    public ResourceLocation getTextureLocation(MagicBolt p_114482_) {
        return TEXTURE_LOCATION;
    }

    public void render(MagicBolt p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
