...
public class WandTipModel extends Model {

    public static final ResourceLocation TEXTURE = new ResourceLocation(Arcane_conjouring.MODID, "textures/item/wand_tip.png");
    private final ModelPart root;

    public WandTipModel(ModelPart root) {
